...
func dockerfile() (*asset, error) {
	...
	info := bindataFileInfo{name: "Dockerfile", size: 365, mode: os.FileMode(420), modTime: time.Unix(1679052108, 0)}
